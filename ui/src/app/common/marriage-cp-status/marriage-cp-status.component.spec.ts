...
import { MarriageCpStatusComponent } from './marriage-cp-status.component';
...
describe('CountryOfResidenceComponent', () => {
  let component: MarriageCpStatusComponent;
  let fixture: ComponentFixture<MarriageCpStatusComponent>;
  let de: DebugElement;
  let el: HTMLElement;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [MarriageCpStatusComponent],
    ...
    fixture = TestBed.createComponent(MarriageCpStatusComponent);
