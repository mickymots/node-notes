...
import { ResponseTopUpRateComponent } from './response-top-up-rate.component';
...
describe('ResponseTopUpRateComponent', () => {
  let component: ResponseTopUpRateComponent;
  let fixture: ComponentFixture<ResponseTopUpRateComponent>;
  let de: DebugElement;
  let el: HTMLElement;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ResponseTopUpRateComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ResponseTopUpRateComponent);
  ...
  it('should be created', () => {
   ...
   it('should display the default label', fakeAsync(() => {
    ...
    el = de.nativeElement;
    fixture.detectChanges();
    expect(el.textContent).toContain('Response Top-Up Rate');
  }));
