...
import { ForenameComponent } from './forename.component';
...
describe('ForenameComponent', () => {
  let component: ForenameComponent;
  let fixture: ComponentFixture<ForenameComponent>;
  let de: DebugElement;
  let el: HTMLElement;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ForenameComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ForenameComponent);
  ...
  it('should be created', () => {
   ...
   it('should display the default label', fakeAsync(() => {
    ...
    el = de.nativeElement;
    fixture.detectChanges();
    expect(el.textContent).toContain('Forename');
  }));
