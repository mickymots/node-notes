...
import { ChildForenameComponent } from './child-forename.component';
...
describe('ChildForeNameComponent', () => {
  let component: ChildForenameComponent;
  let fixture: ComponentFixture<ChildForenameComponent>;
  let de: DebugElement;
  let el: HTMLElement;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ChildForenameComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ChildForenameComponent);
  ...
  it('should be created', () => {
   ...
   it('should display the default label', fakeAsync(() => {
    ...
    el = de.nativeElement;
    fixture.detectChanges();
    expect(el.textContent).toContain('Child Forename');
  }));
